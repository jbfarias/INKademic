...
PAGES = {
    "home":     ("/",         "INKademic",                   "home",     ""),
    "files":    ("/files",    "Files - INKademic",           "files",    '  <script src="/js/jszip.min.js"></script>'),
    "settings": ("/settings", "Settings - INKademic Reader", "settings", ""),
    "fonts":    ("/fonts",    "Fonts - INKademic",           "fonts",    ""),
}
...
if __name__ == "__main__":
    ...
    print(f"INKademic web preview: http://localhost:{port}  (Ctrl+C to stop)")
    try:
        httpd.serve_forever()
