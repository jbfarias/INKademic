...
void SleepActivity::renderDefaultSleepScreen() const {
  ...
  renderer.drawCenteredText(UI_10_FONT_ID, pageHeight / 2 + 70, tr(STR_INKADEMIC), true, EpdFontFamily::BOLD);
...
#ifdef INKADEMIC_SHOW_SLEEP_BUILD_INFO
  const std::string buildInfo = std::string(INKADEMIC_BUILD_ENV) + " " + INKADEMIC_VERSION;
