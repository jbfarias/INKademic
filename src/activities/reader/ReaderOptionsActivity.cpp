...
SettingInfo buildReaderRenderModeSetting() {
  return SettingInfo::Enum(
             ...
             {StrId::STR_RENDER_MODE_INKADEMIC_DEFAULT, StrId::STR_RENDER_MODE_BALANCED, StrId::STR_RENDER_MODE_LIGHT})
      .withEnumRawValues({static_cast<uint8_t>(EpubRenderMode::InkademicDefault),
